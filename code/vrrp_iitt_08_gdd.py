...
img_serie_tiempo = dict(data = gdd_d,
                        ...
                        nombre_ejey = "Grados días de crecimiento (°C)",
                        img_path = img_path,
                        img_save_name = "gdd_d_stiempo_01_21setiembre1999_pacayzapa",
                       )
...
img_hlineas = dict(data=df,
                   ...
                   rango_val = [0,400],
                   nombre_ejex="Grados días de crecimiento (°C)",
                   titulo_derecha="01-21 Setiembre 1999",
...
img_mapa = dict(data=gdd_a,
                ...
                cb_rango= [0, 450, 50],
                tipo_cbar=None,
                cb_nombre="Grados días de crecimiento (°C)",                
                img_path = img_path,
