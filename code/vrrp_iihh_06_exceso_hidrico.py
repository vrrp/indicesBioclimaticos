...
d :diario
"""
eh_a = ii_hh.exceso_hidrico("a")
eh_ar= ii_hh.exceso_hidrico("ar")
eh_d = ii_hh.exceso_hidrico("d")

lons = eh_a.lons; lats=eh_a.lats

print(np.min(eh_a.values), np.max(eh_a.values))
...
img_serie_tiempo = dict(data = eh_ar,
                        ...
                        nombre_ejey = "Exceso Hídrico (mm/día)",
                        img_path = img_path,
