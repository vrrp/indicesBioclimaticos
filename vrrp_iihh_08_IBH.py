...
m : mensual
"""
ibh_a = ii_hh.indice_bienestar_hidrico("a", iswc=100)
ibh_ar= ii_hh.indice_bienestar_hidrico("ar",iswc=100)
ibh_m = ii_hh.indice_bienestar_hidrico("m", iswc=100)
...
#-------------------------------------------------------------------------------
img_serie_tiempo = dict(data = ibh_ar,
                        ...
                        img_path = img_path,
                        img_save_name = "ibh_ar_stiempo_ago98_jul98_pacayzapa",
                       )
