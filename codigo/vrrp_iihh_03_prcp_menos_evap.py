...
# Extraer variables
#------------------------------------------------------------------------
prcp = fo_prcp.variable(nombre_var="prcp", rango_tiempo=['1999-01-01','2000-12-31']) # yyyy-mm-dd
etp = fo_etp.variable(nombre_var="etp", rango_tiempo=['1999-01-01','2000-12-31']) # yyyy-mm-dd
...
## validar
#------------------------------------------------------------------------
pg_prcp = iibb.extraer_data_punto_grilla(prcp, lonlat=[-76.77, -6.28]).data
pg_etp = iibb.extraer_data_punto_grilla(etp,   lonlat=[-76.77, -6.28]).values
pg_pme = iibb.extraer_data_punto_grilla(pme_d, lonlat=[-76.77, -6.28]).data
...
df.to_excel(img_path+"excel/pme_validación_1999_2000.xlsx", header=True,index=False)
...
#-------------------------------------------------------------------------------
img_serie_tiempo = dict(data = pme_ar,
                        ...
                        img_path = img_path,
                        img_save_name = "pme_ar_stiempo_01_21setiembre1999_pacayzapa",
                       )
