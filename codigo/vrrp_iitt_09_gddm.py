...
d :diario
"""
gdd_a = ii_tt.gddm("a", tb=10)
gdd_ar = ii_tt.gddm("ar", tb=10)
gdd_d = ii_tt.gddm("d", tb=10)
...
#-------------------------------------------------------------------------------
img_serie_tiempo = dict(data = gdd_d,
                        punto_grilla = [-76.77, -6.28],
                        titulo_derecha = "01-21 SETIEMBRE 1999",
                        titulo_izquierda = "ÍNDICE BIOCLIMÁTICO: ESTACIÓN PACAYZAPA",
                        nombre_ejey = "Grados días de crecimiento mod (°C)",
                        img_path = img_path,
                        img_save_name = "gddm_d_stiempo_01_21setiembre1999_pacayzapa",
                       )
...
img_mapa = dict(data=gdd_a,
                ...
                cb_rango= [0, 450, 50],
                tipo_cbar=None,
                cb_nombre="Grados días de crecimiento mod(°C)",                
                img_path = img_path,
                shp_path = "/home/data/shape/depart_san_martin/",
                img_save_name="gddm_a_map_01_21sep1999_san_mantin",
                )
