...
#-------------------------------------------------------------------------------
img_serie_tiempo = dict(data = etp_ar,
                        ...
                        img_path = img_path,
                        img_save_name = None,#"etp_ar_stiempo_01_21setiembre1999_pacayzapa",
                       )
...
img_hlineas = dict(data=df,
                   ...
                   img_path = img_path,
                   img_save_name=None,#"etp_a_hlines_aws_1999_san_mantin",
                   )
...
img_mapa = dict(data=etp_a,
                ...
                img_save_name=None,#"etp_a_map_01_21sep1999_san_mantin",
                )
...
#------------------------------------------------------------------------
dic = {"data": etp_a,
       "nombre_guardar": "etp_ac_01_21setiembre_1999_saved2023.tif",
       }
